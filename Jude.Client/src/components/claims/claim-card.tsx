    ...
    >
      ...
      <div className="flex justify-between items-start mb-3">
        ...
        <div className="text-right">
          <span className="text-xs text-gray-500 font-mono">{claim.transactionNumber}</span>
          {claim.isFlagged && (
      ...
      <div className="mb-3">
        <h3 className="font-semibold text-gray-800 mb-1">{claim.patientName}</h3>
      ...
      <div className="flex justify-between items-center mb-3">
        <div className="flex items-center text-gray-700">
          ...
          <span className="font-medium">{claim.currency}{claim.claimAmount.toLocaleString()} claimed</span>
        </div>
      </div>
